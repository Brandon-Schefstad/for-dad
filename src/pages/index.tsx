...
const IndexPage: React.FC<PageProps> = () => {
  ...
  return (
    <>
      <body className="text-white bg-black min-h-screen  px-2 pb-24 max-w-[1920px] m-auto xl:px-8">
        <section className="wrapper grid gap-2 ">
          ...
          >
            ...
            <section
              className={`nature--pictures grid grid-cols-7 gap-2 mt-[-1rem]`}
            >
              ...
              <section
                className={`florida col-span-7 grid gap-2 xl:gap-8 align-center`}
              >
          ...
          <section id="Auto" className="relative nature col-span-7 grid gap-4">
            ...
            <h2 className="absolute mt-2 right-0 text-2xl md:text-3xl lg:text-4xl xl:text-6xl  translate-y-1/2 px-8 glass font-semibold">
              Automotive
            </h2>
