...
const Navbar = () => {
	return (
		<>
			...
			<div className="btm-nav bg-black z-30 mb-2 xl:mb-0 glass fixed bottom-0 left-0 col-span-4 px-4 pt-[-1rem]xl:pt-4 border-2 border-white  border-solid grid grid-cols-3 gap-8 ">
				<a href="#Nature">
					<div className="nav-item text-sm btn xl:w-1/2  w-full hover:text-white  rounded-none hover:bg-black bg-slate-200 text-black">
						Nature
					</div>
				</a>
				<a href="#Auto">
